...
def oneVaccinationStudy(mask_adopt, dist_adopt, mask_eff, dist_eff):
    ...
    if 1:
       ...
       # nb_wk: number of ranked workplaces to vaccinate (from largest to smallest)
       for nb_wk in [0]:
        ...
        # nb_wk: number of ranked schools to vaccinate (from largest to smallest)
        for nb_sch in [0]:
         print("SCRIPT: nb_sch to vaccinate: ",nb_sch)
         # percentage of the overall populace to vaccinate [0 - 1.]
         for v_pop_perc in [0.0]:
          # percent of people to vaccinate in the workplace and schools. Assumes the same percentage
          # in both environment types
...
def oneSetOfVaccinationStudies():
    mask_adopt = 0.0  # all environments (percentage of people wearing masks)
    dist_adopt = 0.0  # all environments (percentage of people social distancing)
    # if mask_adopt and dist_adopt = 0, efficiencies for masks and social distancing have no effect
...
if __name__  == "__main__":
    ...
    # sim_rep: number of repetitions of the simulation
