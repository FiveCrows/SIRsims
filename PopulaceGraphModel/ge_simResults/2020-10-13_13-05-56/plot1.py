...
def plotMaxInfections(df0, fn):
    ...
    for k in range(20):
        if 1:
            ...
            ax.imshow(mat, vmin=0.0, vmax=0.4, cmap='hot', extent=[-0.05,0.45,-0.05,0.45], interpolation='nearest', origin='lower')
            #ax.imshow(mat, cmap='viridis', extent=[-0.05,0.45,-0.05,0.45], interpolation='nearest', origin='lower')
