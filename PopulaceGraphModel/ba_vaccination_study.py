...
env_type_scalars = {"household": 1.0, "school": 1.0, "workplace": 1.0}
    ...
    if 1:
        ...
        for nb_wk in [0]:
            ...
            for nb_sch in [0, 5, 10, 20, 40, 60]:
                starting_schools = model.nb_schools
            ...
            for v_pop_perc in [0.0]:
                ...
                model.set_nbTopWorkplacesToVaccinate(nb_wk,
                                                     perc_vacc_work)  # should set in term of number of available vaccinations
                # make sure first index < nb schools (nb schools, perc vaccinated)vaccinated)
                model.set_nbTopSchoolsToVaccinate(nb_sch,
                                                  perc_vacc_school)  # should set in term of number of available vaccinations
                ...
                finishing_schools = model.nb_schools
