...
class TransmissionWeighter:
    ...
    def getWeight(self, personA, personB, environment):
        ...
        if environment.preventions != None:
            ...
            # prevention_reductions: effectiveness of particular prevention. 
            #    if prevention_reduction == 1, prevention_reduction
            p1 = self.prevention_reductions["distancing"]
            q1 = environment.preventions["distancing"]

            # q1 == 0: no effect on weight. 
            # q1 == 1: weight *= p1
            # p1 == 0: weight *= 1-q1
            # p1 == 1: weight unchanged
            weight = weight * (1 - (1-p1)*q1)
