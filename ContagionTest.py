...
model.plotContactMatrix('age', 5)
model.simulate(gamma, tau, title = "Control test")
model.fitWithContactMatrix(contactMatrixUSA_Base, 'age', 5)
model.plotContactMatrix('age', 5)
model.build(model.clusterStrogatz)
model.simulate(gamma, tau, title = "After Simulation")
model.plotSIR()