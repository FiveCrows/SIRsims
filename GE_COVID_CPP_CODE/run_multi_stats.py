...
run_index = 5    # <<<< Set to create a new run
...
def plot_infections_by_degree(delta_time, ax, folders, global_dict):
    if 1:
        ...
        #ax.plot(times, (infected+latent)/N, color=col, lw=lw) #, label="IS+L")
